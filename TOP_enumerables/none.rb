...
puts 'my_none output'
puts arr_one.my_none? { |word| word.length > 3}
puts arr_two.my_none? { |word| word.length > 3}

puts 'enumerable output'
puts arr_one.none? { |word| word.length > 3}
puts arr_two.none? { |word| word.length > 3}